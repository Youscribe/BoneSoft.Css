...
namespace BoneSoft.CSS
{
    ...
    public class UTF8Buffer : Buffer
    {
        ...
        public override int Read()
        {
            ...
            if (ch < 128 || ch == EOF)
            {
                // nothing to do, first 127 chars are the same in ascii and utf8 0xxxxxxx or end of
                // file character
            }
    ...
    public class Scanner
    {
        ...
        void NextCh()
        {
            ...
            else
            {
                pos = buffer.Pos;
                ch = buffer.Read(); col++;
                // replace isolated '\r' by '\n' in order to make eol handling uniform across
        ...
        void CheckLiteral()
        {
            switch (t.val)
            {
                ...
                case "important": if (lt.val != ".") t.kind = 45; break;
                default: break;
            }
        }
